...
func ConvertToKwitansiResponse(k model.Kwitansi) responses.KwitansiResponse {
	return responses.KwitansiResponse{
		...
		Pegawai: responses.PegawaiResponse{
			...
			Nip:           k.Pegawai.Nip,
			Nama:          k.Pegawai.Nama,
			Jenis_Kelamin: k.Pegawai.Jenis_Kelamin,
			Status:        k.Pegawai.Status,
			Tempat_Lahir:  k.Pegawai.Tempat_Lahir,
			Tanggal_Lahir: k.Pegawai.Tanggal_Lahir,
			Instansi:      k.Pegawai.Instansi,
			BidangId:      k.Pegawai.BidangId,
			Bidang: responses.BidangResponse{
				Id:          k.Pegawai.Bidang.Id,
				Nama_Bidang: k.Pegawai.Bidang.Nama_Bidang,
				Singkatan:   k.Pegawai.Bidang.Singkatan,
			},
			Golongan:         k.Pegawai.Golongan,
			Eselon:           k.Pegawai.Eselon,
			Pangkat:          k.Pegawai.Pangkat,
			Jabatan:          k.Pegawai.Jabatan,
			StatusPerjalanan: k.Pegawai.StatusPerjalanan,
			UserId:           k.Pegawai.UserId,
		},
...
func ConvertToRincianKwitansiPenerbanganResponse(r model.RincianKwitansiPenerbangan) responses.RincianKwitansiPenerbanganResponse {
	return responses.RincianKwitansiPenerbanganResponse{
		Id:         r.Id,
		KwitansiId: r.KwitansiId,
		Kwitansi: responses.KwitansiResponse{
			Id:     r.Kwitansi.Id,
		...
		NamaMaskapai: r.NamaMaskapai,
		NomorTiket:   r.NomorTiket,
